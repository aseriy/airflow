...
COCKROACHDB_BACKEND = "cockroachdb"
NONE_BACKEND = "none"
ALLOWED_BACKENDS = [SQLITE_BACKEND, MYSQL_BACKEND, POSTGRES_BACKEND, COCKROACHDB_BACKEND, NONE_BACKEND]
ALLOWED_PROD_BACKENDS = [MYSQL_BACKEND, POSTGRES_BACKEND, COCKROACHDB_BACKEND]
...
ALLOWED_COCKROACHDB_VERSIONS = ["25.2.2"]
