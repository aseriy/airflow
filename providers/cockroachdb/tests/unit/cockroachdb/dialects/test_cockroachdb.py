...
class TestCockroachDBDialect:
    ...
    def test_placeholder(self):
        assert CockroachDBDialect(self.test_db_hook).placeholder == "?"

    def test_get_column_names(self):
        assert CockroachDBDialect(self.test_db_hook).get_column_names("hollywood.actors") == [
            "id",
            "name",
            "firstname",
            "age",
    ...
    def test_get_target_fields(self):
        assert CockroachDBDialect(self.test_db_hook).get_target_fields("hollywood.actors") == [
            "name",
            "firstname",
            "age",
        ]
    ...
    def test_get_primary_keys(self):
        assert CockroachDBDialect(self.test_db_hook).get_primary_keys("hollywood.actors") == ["id"]
    ...
    def test_generate_replace_sql(self):
        ...
        sql = CockroachDBDialect(self.test_db_hook).generate_replace_sql(
